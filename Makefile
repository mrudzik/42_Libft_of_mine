...
#    Updated: 2018/04/13 17:06:27 by mrudzik          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRC = ft_atoi.c ft_itoa.c ft_bzero.c \
	  ...
	  ft_iswhite.c ft_foreach.c ft_range.c ft_count_if.c ft_sqrt.c
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	  ...
	  ft_strnstr.o ft_strrchr.o ft_strsplit.o \
	  ft_strstr.o ft_strsub.o ft_strtrim.o ft_tolower.o ft_toupper.o \
	  ft_iswhite.o ft_foreach.o ft_range.o ft_count_if.o ft_sqrt.o
HDR = libft.h

$(NAME):
	gcc -c $(SRC) -I libft.h -Wall -Wextra -Werror
	ar rc $(NAME) $(OBJ)
	ranlib $(NAME)
